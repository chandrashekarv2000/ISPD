...
video=cv2.VideoWriter('C://Users//cs_loneranger_//Videos//Captures//'+sample+'.avi',cv2.VideoWriter_fourcc(*'XVID'),60,(360,240))
while True:
    ...
    if v[10]==1:
        ...
        cv2.imwrite('C://Users//cs_loneranger_//OneDrive//Desktop//ispd_picture//'+ capture + '.png', img)
    ...
    if v[6]:
        ...
        if a!="None":
            try:
                pic = cv2.imread("C://Users//cs_loneranger_//OneDrive//Desktop//Criminals/"+a+".jpeg")
                ...
                pic = cv2.imread("C://Users//cs_loneranger_//OneDrive//Desktop//Criminals/" + a + ".jpg")
                cv2.imshow("criminal image", cv2.resize(pic,(500,500)))
                result = example.criminal_details(a)
                print("\n")
